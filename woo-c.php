...
function custom_text_after_checkout_fields() {
    echo get_field('politics_details', 'options');
}
add_action('woocommerce_after_order_notes', 'custom_text_after_checkout_fields', 20);
...
function add_product_image_to_checkout($product_name, $cart_item, $cart_item_key)
{
    ...
    $thumbnail = $product->get_image([100, 100]);
