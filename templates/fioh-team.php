        ...
        <ul class="fioh-team__project__list">
          ...
          <li class="fioh-team__project__item" style="display: none;">
            <div class="fioh-team__project__img-wp">
              <img class="fioh-team__project__img" src="<?php echo esc_url($photo['sizes']['medium_large']); ?>"
          ...
          <div class="swiper-wrapper">
            <?php
                            ...
                            while (have_rows('fioh-team_team-repeater')):
                                ...
                                $counter++;
                                ?>
            <div class="fioh-team__team-repeater-item swiper-slide">
              ...
              <div class="fioh-team__team-repeater-item-text-wrapper">
                <button class="fioh-team__team-repeater-item-readmore"
                  data-show-text="<?php the_field('read_btn', 'option'); ?>"
                  data-hide-text="<?php the_field('hide_btn', 'option'); ?>">
                  <span><?php the_field('read_btn', 'option'); ?></span>
                  <?php if (get_field('svg_down')): ?>
                  <img class="fioh-team__team-repeater-item-arrow" width="12" height="6"
                    src="<?php the_field('svg_down'); ?>" />
                  <?php endif; ?>
                </button>
