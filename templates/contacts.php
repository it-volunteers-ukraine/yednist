        ...
        <div class="contacts__page-body">
          <div class="contacts__form">
            ...
            <div id="contactForm" name="form-contact" class="form__contacts" method="post">
              <?php echo do_shortcode('[contact-form-7 id="7ddce3e" title="Форма для сторінки Контакти"]') ?>
          ...
          <div class="contacts__page-content">
            ...
            <div class="contacts__page-adress">
              ...
              <ul class="contacts__page-adress-list">
                <li class="contacts__page-adress-item"><a href="<?php the_field('contacts-adress-link'); ?>"
                    target="_blank">
                    <p class="contacts__page-adress-text"><?php the_field('address_label_1', 'option'); ?></p>
                  </a></li>
                <li class="contacts__page-adress-item">
                  <p class="contacts__page-adress-text"><?php the_field('address_label_2', 'option'); ?></p>
                </li>
                <li class="contacts__page-adress-item">
                  <p class="contacts__page-adress-text"><?php the_field('address_label_3', 'option'); ?></p>
                </li>
                <li class="contacts__page-adress-item">
                  <p class="contacts__page-adress-text"><?php the_field('address_label_4', 'option'); ?></p>
                </li>
              </ul>
            </div>
              ...
              <ul class="contacts__page-social-list">
                <li class="contacts__page-social-item">
                  ...
                  <a href="<?php echo esc_url($link_url); ?>" target="_blank">
                    <svg class="icon">
                      <use xlink:href="<?php bloginfo('template_url'); ?>/assets/images/sprite.svg#telegram"
                        alt="telegram"></use>
                    </svg>
                ...
                <li class="contacts__page-social-item">
                  ...
                  <a href="<?php echo esc_url($link_url); ?>" target="_blank">
                    <svg class="icon">
                      <use xlink:href="<?php bloginfo('template_url'); ?>/assets/images/sprite.svg#facebook"
                        alt="facebook"></use>
                    </svg>
                    <?php echo esc_html($link_title); ?>
                  </a>
                ...
                <li class="contacts__page-social-item">
                  ...
                  <a href="<?php echo esc_url($link_url); ?>" target="_blank">
                    <svg class="icon">
                      <use xlink:href="<?php bloginfo('template_url'); ?>/assets/images/sprite.svg#instagram"
                        alt="instagram"></use>
                    </svg>
                    <?php echo esc_html($link_title); ?>
                  </a>
                ...
                <li class="contacts__page-social-item">
                  ...
                  <a href="<?php echo esc_url($link_url); ?>" target="_blank">
                    <svg class="icon">
                      <use xlink:href="<?php bloginfo('template_url'); ?>/assets/images/sprite.svg#twitter"
                        alt="twitter"></use>
                    </svg>
                    <?php echo esc_html($link_title); ?>
                  </a>
                ...
                <li class="contacts__page-social-item">
                  ...
                  <a href="<?php echo esc_url($link_url); ?>" target="_blank">
                    <svg class="icon">
                      <use xlink:href="<?php bloginfo('template_url'); ?>/assets/images/sprite.svg#linkedin"
                        alt="linkedin"></use>
                    </svg>
                    <?php echo esc_html($link_title); ?>
                  </a>
              ...
              <ul class="contacts__page-social-list">
                <li>
                  <a href="tel:<?php the_field('social_phone', 'option') ?>">
                    <svg class="icon">
                      <use xlink:href="<?php bloginfo('template_url'); ?>/assets/images/sprite.svg#phone" alt="phone">
                      </use>
                    </svg>
                ...
                <li>
                  <a href="mailto:<?php the_field('social_mail', 'option') ?>">
                    <svg class="icon">
                      <use xlink:href="<?php bloginfo('template_url'); ?>/assets/images/sprite.svg#mail" alt="mail">
                      </use>
                    </svg>
