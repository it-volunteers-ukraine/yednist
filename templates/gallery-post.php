  ...
  <section class="section galery-post">
    <div class="container">
      <div class="inner-container">
        <h2 class="galery-post__title page-title"><?php the_title(); ?></h2>
        <div class="galery-post__body">
          <?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
          <div class="galery-post__content">
            <p class="galery-post__text"><?php echo $gallery_post_text; ?></p>
          </div>

          <?php foreach ($gallery_post_img as $img_list) :?>
          <div class="galery-post__img">
            <a data-fslightbox="gallery" href="<?php echo $img_list['url'] ?>">
              <img src="<?php echo $img_list['sizes']['medium_large'] ?>"
                alt="<?php echo $img_list['sizes']['medium_large']; ?>">
            </a>
          </div>
          <?php endforeach ?>
